        ...
        public void Show(Action<int> onItemSelected)
        {
            ...
            if (isClickedComboButton)
            {
                ...
                CurrentDropdownDrawer = () =>
                {
                    ...
                    var outerRectLocalMINXY = GUIUtility.ScreenToGUIPoint(new Vector2(outerRectScreen.xMin, outerRectScreen.yMin));
                    var outerRectLocalMAXXY = GUIUtility.ScreenToGUIPoint(new Vector2(outerRectScreen.xMax, outerRectScreen.yMax));
                    var outerRectLocal = new Rect() { xMax = outerRectLocalMAXXY.x, yMax = outerRectLocalMAXXY.y, xMin = outerRectLocalMINXY.x, yMin = outerRectLocalMINXY.y };
