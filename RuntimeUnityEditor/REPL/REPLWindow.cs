        ...
        public void DisplayWindow()
        {
            ...
            if (_completionsListingStyle == null)
            {
                _completionsListingStyle = new GUIStyle(GUI.skin.button)
                {
                    ...
                    hover = { background = new Texture2D(10,10), textColor = Color.black },
                    normal = { background = null },
                    focused = { background = new Texture2D(10, 10), textColor = Color.black },
                    active = { background = new Texture2D(10, 10), textColor = Color.black }
                };
            }
